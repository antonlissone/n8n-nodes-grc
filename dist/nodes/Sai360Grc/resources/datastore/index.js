...
exports.datastoreDescription = exports.directExecute = exports.primeForPagination = void 0;
const primeForPagination = __importStar(require("./primeForPagination"));
exports.primeForPagination = primeForPagination;
const directExecute = __importStar(require("./directExecute"));
exports.directExecute = directExecute;
const showOnlyForDatastore = {
    resource: ['datastore'],
};
exports.datastoreDescription = [
    {
